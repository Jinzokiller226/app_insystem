        ...
        <table class=" w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                        ...
                        @foreach($posData as $data)
                                ...
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                @if(auth()->user()->role->is_admin == 1)<button class="text-blue-400" wire:click="delete({{$data->id}})" type="button" >Delete</button>  | @endif <button class="text-blue-400" wire:click="getIDfromItem({{$data->id}})" type="button" >Mark as Completed</button>
